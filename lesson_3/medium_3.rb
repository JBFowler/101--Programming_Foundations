...
def question3
  question(3)
  prompt("My string looks like this now: 'pumpkins'.  This is because the function performed on the string is not mutating.  It also is pointing to a new object within the method.")
  prompt("My array looks like this now: ['pumpkins', 'rutabaga'].  The push method used on the array is mutating, therefore mutating the caller.  An array can also hold multiple elements, which allows the array object to remain the same within the method.")
end

def question4
  question(4)
  prompt("My string looks like this now: 'rutabaga'.")
  prompt("My array looks like this now: ['pumpkins'].")
end
...
def question5
  ...
  prompt("Statements are automatically evaluated to true or false.")
end
